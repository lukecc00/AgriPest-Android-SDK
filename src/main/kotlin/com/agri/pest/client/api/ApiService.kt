...
interface ApiService {
     ...
     * @return [Call]<[ResultPageCommentResponseDto]>
     */
    @GET("api/admin/community/comments")
    fun getAllComments(@Query("page") page: kotlin.Int? = 0, @Query("size") size: kotlin.Int? = 10): Single<ResultPageCommentResponseDto>
     ...
     * @param page  (optional, default to 0)
     * @param size  (optional, default to 10)
     * @return [Call]<[ResultPagePostResponseDto]>
     */
    @GET("api/admin/community/posts")
    fun getAllPosts(@Query("tag") tag: kotlin.String? = null, @Query("q") q: kotlin.String? = null, @Query("page") page: kotlin.Int? = 0, @Query("size") size: kotlin.Int? = 10): Single<ResultPagePostResponseDto>
    ...
    fun getComments(@Path("id") id: kotlin.Long, @Query("page") page: kotlin.Int? = 0, @Query("size") size: kotlin.Int? = 10): Single<ResultPageCommentResponseDto>
     ...
     */
    @GET("api/posts/mine")
    fun getMyPosts(@Query("page") page: kotlin.Int? = 0, @Query("size") size: kotlin.Int? = 10): Single<ResultPagePostResponseDto>
     ...
     */
    @GET("api/posts")
    fun getPosts(@Query("tag") tag: kotlin.String? = null, @Query("q") q: kotlin.String? = null, @Query("page") page: kotlin.Int? = 0, @Query("size") size: kotlin.Int? = 10): Single<ResultPagePostResponseDto>
