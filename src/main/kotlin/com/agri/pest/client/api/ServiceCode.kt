...
object ServiceCode {
    ...
    /**
     * 帖子内容不合法或太短
     * 原始信息: Post content is invalid
     */
    const val POST_CONTENT_IS_INVALID = 4106
    ...
    /**
     * 消息分发失败
     * 原始信息: Failed to send notification
     */
    const val FAILED_TO_SEND_NOTIFICATION = 4503

    /**
     * 搜索关键词太短
     * 原始信息: Search query is too short
     */
    const val SEARCH_QUERY_IS_TOO_SHORT = 4601
